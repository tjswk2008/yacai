        ...
        body: new Container(
          ...
          child: new Column(
            ...
            children: <Widget>[
              Padding(
                  padding:
                      EdgeInsets.only(top: 140 * factor, bottom: 40 * factor),
                  child: new Text("欢迎登陆丫财",
                      style: new TextStyle(
                          color: Colors.black, fontSize: 60.0 * factor))),
              Row(
                children: <Widget>[
                  Text("手机验证后自动注册，注册即代表阅读并同意",
                      style: new TextStyle(
                          color: Colors.grey, fontSize: 22.0 * factor)),
                  InkWell(
                    onTap: () {},
                    child: Text("服务条款",
                        style: new TextStyle(
                            color: Colors.lightBlue, fontSize: 22.0 * factor)),
                  )
                ],
              ),
                      ...
                      child: Container(
                        ...
                        child: RaisedButton(
                          ...
                          child: Text(
                            "发送验证码",
                            style: new TextStyle(
                                fontSize: 26.0 * factor, color: Colors.white),
                          ),
                          onPressed: () async {
                  ...
                  child: new Row(
                    ...
                    children: <Widget>[
                      ...
                      new InkWell(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsets.symmetric(horizontal: 10 * factor),
                            child: Container(
                              decoration: BoxDecoration(
                                  border: Border(
                                      bottom: BorderSide(
                                          width: factor, color: Colors.black))),
                              child: new Text('登录',
              ...
              new Expanded(
                  child: new Column(
                children: <Widget>[new Expanded(child: loadingView)],
              ))
            ],
          ),
        ));
