                ...
                new SingleChildScrollView(
                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      new Row(
                        ...
                        children: <Widget>[
                          ...
                          new InkWell(
                            onTap: () {
                              ImagePicker.pickImage(source: ImageSource.gallery)
                                ...
                                return Api().upload(image,
                                    '${userName}_avatar${DateTime.now().microsecondsSinceEpoch}${image.path.substring(image.path.lastIndexOf("."))}');
                            ...
                            child: personalInfo.avatar != null
                                ? new CircleAvatar(
                                    radius: 45.0 * factor,
                                    backgroundImage:
                                        new NetworkImage(personalInfo.avatar))
                                : new Image.asset(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          new InkWell(
                            ...
                            child: Text(
                              personalInfo.residenceArea == null
                                  ? '请选择'
                                  : '上海市 ${personalInfo.residenceArea}',
                              style: TextStyle(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          new InkWell(
                            ...
                            child: Text(
                              personalInfo.nativeProvince == null
                                  ? '请选择'
                                  : '${personalInfo.nativeProvince} ${personalInfo.nativeCity}',
                              style: TextStyle(
                                  fontSize: 26.0 * factor, color: Colors.grey),
                            ),
                          ),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          new InkWell(
                            ...
                            child: Text(
                              personalInfo.marriage == null
                                  ? '请选择'
                                  : marriageArr[personalInfo.marriage],
                              style: TextStyle(
                                  fontSize: 26.0 * factor, color: Colors.grey),
                            ),
                          ),
                        ...
                        children: <Widget>[
                          ...
                          new InkWell(
                            onTap: () {
                              showDatePicker(
                                context: context,
                                initialDate: personalInfo.firstJobTime == null
                                    ? DateTime.now()
                                    : DateTime.parse(personalInfo.firstJobTime),
                                firstDate: personalInfo.firstJobTime == null
                                    ? DateTime.parse('1950-01-01')
                                    : DateTime.parse(personalInfo.firstJobTime)
                                        .subtract(
                                            new Duration(days: 30)), // 减 30 天
                            ...
                            child: new Text(
                              personalInfo.firstJobTime == null
                                  ? '请选择'
                                  : personalInfo.firstJobTime,
                              style: TextStyle(fontSize: 26.0 * factor),
                            ),
                      ...
                      new Padding(
                        ...
                        child: new TextField(
                          controller: TextEditingController.fromValue(
                              TextEditingValue(
                                  // 设置内容
                                  text: personalInfo.wechatId == null
                                      ? ''
                                  ...
                                  selection: TextSelection.fromPosition(
                                      TextPosition(
                                          affinity: TextAffinity.downstream,
                                          offset: personalInfo.wechatId == null
                                              ? 0
                                              : personalInfo
                                                  .wechatId.length)))),
                          style: TextStyle(fontSize: 26.0 * factor),
                          ...
                          controller: TextEditingController.fromValue(
                              TextEditingValue(
                                  ...
                                  selection: TextSelection.fromPosition(
                                      TextPosition(
                                          affinity: TextAffinity.downstream,
                                          offset: personalInfo.email == null
                                              ? 0
                          ...
                          new InkWell(
                            onTap: () {
                              showDatePicker(
                                ...
                                firstDate: personalInfo.birthDay == null
                                    ? DateTime.parse('1950-01-01')
                                    : DateTime.parse(personalInfo.birthDay)
                                        .subtract(
                                            new Duration(days: 30)), // 减 30 天
                      ...
                      new Padding(
                        padding: EdgeInsets.only(
                            top: 20 * factor, bottom: 30.0 * factor),
                        child: new Text(
                          '我的优势：',
                          textAlign: TextAlign.left,
                          style: new TextStyle(fontSize: 28.0 * factor),
