                    ...
                    children: <Widget>[
                      ...
                      new Row(
                        ...
                        children: <Widget>[
                          Padding(
                            padding:
                                EdgeInsets.symmetric(vertical: 32 * factor),
                            child: new Text(
                              '颁发时间：',
                              textAlign: TextAlign.left,
                              style: new TextStyle(fontSize: 28.0 * factor),
                          ...
                          Padding(
                            padding:
                                EdgeInsets.symmetric(vertical: 20 * factor),
                            child: new InkWell(
                              onTap: () {
                                showDatePicker(
                                  context: context,
                                  ...
                                  setState(() {
                                    _certification.qualifiedTime = formatDate(
                                        val, [yyyy, '-', mm, '-', dd]);
                                  });
                                }).catchError((err) {
                                  print(err);
                              ...
                              actions: <Widget>[
                                new TextButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    Api()
                                        .deleteCertification(_certification.id)
                                      ...
                                      resume.certificates.removeWhere(
                        ...
                        Api()
                          ...
                          if (_certification.id == null) {
                            resume.certificates.add(
                                Certification.fromMap(response.data['info']));
                            StoreProvider.of<AppState>(context)
                                .dispatch(SetResumeAction(resume));
                          } else {
                            for (var i = 0;
