                      ...
                      new Row(
                        ...
                        children: <Widget>[
                          ...
                          new InkWell(
                            ...
                            child: new Text(_project.startTime, style: TextStyle(fontSize: 26.0*factor),),
                          )
                        ],
                      ),
                      new Divider(),
                      new Row(
                        ...
                        children: <Widget>[
                          ...
                          new InkWell(
                            ...
                            child: new Text(_project.endTime == null ? '至今' : _project.endTime, style: new TextStyle(fontSize: 26.0*factor),),
                          )
                        ],
                      ),
                      new Divider(),
