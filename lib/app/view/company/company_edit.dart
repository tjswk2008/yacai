...
class CompanyEditState extends State<CompanyEdit>
  ...
  void initState() {
    ...
    setState(() {
      ...
      } else if (company.imgs != null &&
          company.imgs[company.imgs.length - 1]['url'] != '') {
      ...
      body: new SingleChildScrollView(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            new Padding(
              padding:
                  EdgeInsets.only(top: 30.0 * factor, bottom: 30.0 * factor),
              child: new Text(
                '公司位置：',
                textAlign: TextAlign.left,
                style: new TextStyle(fontSize: 32.0 * factor),
            ...
            new InkWell(
              ...
              child: Text(
                (company.province == null || company.province == '') &&
                        (company.area == null || company.area == '')
                    ? '请选择地址'
                    : '上海市 ${company.area}',
                style:
                    TextStyle(fontSize: 26.0 * factor, color: Colors.grey[800]),
              ),
            ),
            new Padding(
              ...
              child: new TextField(
                ...
                decoration: new InputDecoration(
                    ...
                    contentPadding: EdgeInsets.only(
                        top: 15 * factor, bottom: 20.0 * factor)),
              ),
            ),
            prefix0.Divider(),
            Row(
              ...
              children: <Widget>[
                new Padding(
                  padding: EdgeInsets.only(
                      top: 30.0 * factor, bottom: 20.0 * factor),
                  child: new Text(
                    '公司性质：',
                    textAlign: TextAlign.left,
                    style: new TextStyle(fontSize: 32.0 * factor),
                ...
                new Padding(
                    ...
                    child: new InkWell(
                      ...
                      child: new Text(
                        company.type == null || company.type == ''
                            ? '请选择'
                            : company.type,
                        style: TextStyle(fontSize: 26.0 * factor),
                      ),
              ...
              children: <Widget>[
                ...
                new Padding(
                    ...
                    child: new InkWell(
                      ...
                      child: new Text(
                        company.employee == null || company.employee == ''
                            ? '请选择'
                            : company.employee,
                        style: TextStyle(fontSize: 26.0 * factor),
                      ),
                      ...
                      onTap: () {
                        ImagePicker.pickImage(source: ImageSource.gallery)
                          ...
                          return Api().upload(image,
                              '${userName}_company_logo${DateTime.now().microsecondsSinceEpoch}${image.path.substring(image.path.lastIndexOf("."))}');
            ...
            Row(
              children: <Widget>[
                Padding(
                  padding:
                      EdgeInsets.only(top: 30 * factor, bottom: 30.0 * factor),
                  child: new Text(
                    '详情图：',
                    textAlign: TextAlign.left,
                    style: new TextStyle(fontSize: 32.0 * factor),
                ...
                return InkWell(
                  onTap: () {
                    ImagePicker.pickImage(source: ImageSource.gallery)
                      ...
                      return Api().upload(image,
                          '${userName}_company_detail${DateTime.now().microsecondsSinceEpoch}${image.path.substring(image.path.lastIndexOf("."))}');
                    }).then((Response response) {
                      if (response.data['code'] != 1) {
                        return;
                      }
                      setState(() {
                        ...
                        company.imgs.replaceRange(index, index + 1, [
                          {
                            'id': company.imgs[index]['id'],
                  ...
                  child:
                      company.imgs != null && company.imgs[index]['url'] != ''
                          ? Stack(
                              children: <Widget>[
                                SizedBox.expand(
                                  child: Container(
                          ...
                          : Container(
                              decoration: BoxDecoration(
                                  border: Border.all(
                                      width: factor, color: Colors.grey)),
