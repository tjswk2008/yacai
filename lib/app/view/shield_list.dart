...
class ShieldListState extends State<ShieldList> with TickerProviderStateMixin {
                          ...
                          children: <Widget>[
                            TypeAheadField(
                              textFieldConfiguration: TextFieldConfiguration(
                                ...
                                decoration: new InputDecoration(
                                    ...
                                    border: new UnderlineInputBorder(
                                        borderSide:
                                            BorderSide(width: 1.0 * factor)),
                                    contentPadding:
                                        EdgeInsets.all(20.0 * factor)),
                              ),
                              ...
                              onSuggestionSelected: (suggestion) async {
                                Company newCompany =
                                    Company.fromMap(suggestion);
                                bool hasElement = list.any((Company company) =>
