                          ...
                          showDialog<Null>(
                            ...
                            builder: (BuildContext context) {
                              return new AlertDialog(
                                ...
                                content: Text(
                                  "  确认要注销您的账号吗？注销后别人无法再预览或搜索查阅到您的信息，您也无法登陆我们的app",
                                  style: TextStyle(
                                      fontSize: 28 * factor, height: 1.6),
                                ),
                                actions: <Widget>[
                                  new TextButton(
                                    child: new Text(
                              ...
                              new Padding(
                                ...
                                child: new Row(
                                  children: <Widget>[
                                    new Padding(
                                      padding:
                                          EdgeInsets.only(right: 15.0 * factor),
                            ...
                            children: <Widget>[
                              ...
                              new Container(
                                ...
                                child: Switch.adaptive(
                                  ...
                                  activeColor:
                                      Theme.of(context).primaryColor, // 激活时原点颜色
